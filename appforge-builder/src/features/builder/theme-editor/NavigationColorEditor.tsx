...
const NAVIGATION_FIELDS: { key: string; label: string; path: string[] }[] = [
  { key: 'background', label: 'Fondo',     path: ['colors', 'navigation', 'background'] },
  { key: 'active',     label: 'Activo',    path: ['colors', 'navigation', 'active']     },
  { key: 'inactive',   label: 'Inactivo',  path: ['colors', 'navigation', 'inactive']   },
  { key: 'indicator',  label: 'Indicador', path: ['colors', 'navigation', 'indicator']  },
];

export const NavigationColorEditor: React.FC = () => {
  ...
  return (
    <div className="space-y-2">
      <p className="text-xs font-medium text-gray-700">Menú</p>
